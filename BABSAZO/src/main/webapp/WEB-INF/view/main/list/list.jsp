...
<link href="${pageContext.request.contextPath}/resources/lib/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
...
<link href="${pageContext.request.contextPath}/resources/lib/Magnific-Popup/magnific-popup.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/css/style.css?ver=5" rel="stylesheet">
...
<script src="${pageContext.request.contextPath}/resources/lib/sidr/jquery.sidr.min.js"></script>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="menu">
			<div class="container">
				<a class="navbar-brand" href="main.do"><img
					src="${pageContext.request.contextPath}/resources/img/밥사조로고.png" alt="Smiley face" height="50" width="90"></a>
...
<c:when test= "${check==null}">
      <li class="nav-item dropdown user-account">
        ...
        <div class="dropdown-menu">
            <a href="main/list/main.do" class="dropdown-item"> <i class="fa fa-home"></i> 메인으로 </a>
            <a href="main/list/list.do" class="dropdown-item"> <i class="fa fa fa-utensils"></i> 매장조회</a> 
											...
											<div class="col-lg-5">
												...
												<div class="item-image">
													<a href="list_info.do?store_no=${storeList.store_no }"><img
														src="${pageContext.request.contextPath}${storeList.simg_root}" class="img-fluid" alt="">
														<%-- src="${pageContext.request.contextPath}/resources/img/store_img/store_layuen.jpg" class="img-fluid" alt=""> --%>
				...
				<div class="col col-md-10">
					<div class="row">
						<div class="col-md-4 col-sm-4">
							...
							<p>
								<span><img src="${pageContext.request.contextPath}/resources/img/밥사조로고.png" alt="Smiley face"
