...
(function ($) {
	...
	$.fn.calendar = function (options) {
		...
		_this.init = function () {
			...
			'<caption style="width: 275px;height: 50px;">' +
			'	<span class="prev" style="height: 50px;"><a href="javascript:void(0);" style="height: 40px;">&larr;</a></span>' +
			'	<span class="next" style="height: 50px;"><a href="javascript:void(0);" style="height: 40px;">&rarr;</a></span>' +
